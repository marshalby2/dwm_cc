...
static const char *fonts[]               = { "Source Code Pro:size=15", "monospace:size=13" };
...
static const Rule rules[] = {
    ...
    /** code   */
    {"jetbrains-toolbox",   NULL,                 NULL,             1 << 1,         1,         0,          0,        -1,      0}, // jetbrains-toolbox
    {"jetbrains-idea",      NULL,     		      "IDEA",            1 << 1,         0,         0,          0,        -1,      0}, // jetbrains-toolbox
    {"code",                NULL,     		      "vscode",          1 << 1,         0,         0,          0,        -1,      0}, // jetbrains-toolbox


    /** 普通优先度 */
    {"bilibili",             NULL,                 NULL,             1 << 5,       0,          0,          0,        -1,      0}, // b 站       tag -> 󰕧
    {"chrome",               NULL,                 NULL,             1 << 6,       0,          0,          0,        -1,      0}, // chrome     tag -> 
    { NULL,                 "qq",                  NULL,             1 << 7,       0,          0,          1,        -1,      0}, // qq         tag ->   无边框
    { NULL,                 "wechat.exe",          NULL,             1 << 8,       0,          0,          1,        -1,      0}, // wechat     tag -> 󰭻  无边框
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0, 0)
    TAGKEYS(XK_2, 1, 0)
    TAGKEYS(XK_3, 2, "siyuan-note")
    TAGKEYS(XK_4, 3, 0)
    TAGKEYS(XK_5, 4, 0)
    TAGKEYS(XK_b, 5, "bilibili")
    TAGKEYS(XK_c, 6, "google-chrome-stable")
    TAGKEYS(XK_y, 7, "linuxqq")
